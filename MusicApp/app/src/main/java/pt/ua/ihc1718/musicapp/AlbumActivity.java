    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_meus_albuns:
                startActivity(new Intent(AlbumActivity.this, AlbumsActivity.class));
                break;
            case R.id.nav_artistas:
            case R.id.nav_meus_artistas:
                startActivity(new Intent(AlbumActivity.this, ArtistsActivity.class));
                break;
            case R.id.nav_musicas:
            case R.id.nav_minhas_musicas:
                startActivity(new Intent(AlbumActivity.this, TracksActivity.class));
                break;
