    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_meus_albuns:
                startActivity(new Intent(TrackActivity.this, AlbumsActivity.class));
                break;
            case R.id.nav_artistas:
            case R.id.nav_meus_artistas:
                startActivity(new Intent(TrackActivity.this, ArtistsActivity.class));
                break;
            case R.id.nav_musicas:
            case R.id.nav_minhas_musicas:
                startActivity(new Intent(TrackActivity.this, TracksActivity.class));
                break;
